...
public struct UIImageColors {
    ...
    func toJSON() -> String {
        ...
        return "{ \"backgroundColor\": \"\(backgroundColor.hexString!)\", \"primaryColor\": \"\(primaryColor.hexString!)\", \"secondaryColor\": \"\(secondaryColor.hexString!)\", \"detailColor\": \"\(detailColor.hexString!)\" }"
